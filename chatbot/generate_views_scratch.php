...
$views = [
    ...
    'board.php' => 'Fluxos (FlowBuilder)',
    'configuracoes.php' => 'Configurações do Painel',
    'registro-api.php' => 'Registo de Tráfego API',
    'gateway-webhook.php' => 'Gateway Webhook WhatsApp',
    'admin.php' => 'Painel Administrativo',
    'agentes-ia.php' => 'Agentes de Inteligência Artificial',
    'chatbots.php' => 'Gerenciamento de Chatbots',
    'marketing.php' => 'Campanhas de Marketing',
    'relatorios.php' => 'Relatórios de Atendimento',
    'notificacoes.php' => 'Notificações do Sistema',
    'suporte.php' => 'Suporte Técnico',
    'users.php' => 'Usuários e Operadores',
    'users-show.php' => 'Detalhes do Usuário',
    'programador-api.php' => 'Consola do Programador',
    'programador-ws-test.php' => 'Teste de WebSocket JSON-RPC',
    'programador-debug.php' => 'Painel de Debug de Parâmetros'
];
